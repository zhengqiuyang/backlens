...
<title>GradLens gradient flow</title>
<style>
...
<body>
<header>
  <h1><span class="lens">GradLens</span> gradient flow &mdash; who eats the gradient?</h1>
  <div id="meta"></div>
</header>
<main>
...
<footer>generated by <code>gradlens.flow.gradient_flow</code> &mdash; single file, zero dependencies; edge thickness &prop; log |gradient mass|</footer>
<script>
