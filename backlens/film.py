...
class BackwardFilm:
    ...
    def open_in_browser(self, path: str = "backlens_film.html") -> None:
        self.save_html(path)
...
def film_backward(loss: Tensor, name: str = "backward pass") -> BackwardFilm:
    ...
    same ordering as :func:`backlens.debug.debug_backward`.
    """
...
<title>BackLens Backprop Film</title>
<style>
  :root {
...
<body>
<header>
  <h1><span class="lens">BackLens</span> &middot; Backprop Film</h1>
  <div id="meta"></div>
</header>
...
<footer>generated by <code>backlens.film</code> &mdash; single file, zero dependencies</footer>
<script>
